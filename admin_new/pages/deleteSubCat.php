                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">Delete Subcatagory</h4>
                                  ...
                                  <div class="card">
                                    <div class="card-body">
                                      ...
                                      <div class="form-group">
                                        <label>Select Parent Catagory</label>
                                      ...
                                      <button style="color:#FFF;" type="submit" name = "show" class="btn btn-info btn-icon-text mt-3"><i class="ti-file btn-icon-prepend"></i>Show</button>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select name = "t2" class="form-control js-example-basic-single w-100">
                                          <option value="">Please select an option</option>
                                          <?php
                                            $response = $cat->get_subcat_with_parentid($_POST["t1"]);
                                            for($i = 0; $i < sizeof($response); $i++) {
                                              echo '<option value="'.$response[$i][0].'">'.$response[$i][1].'</option>';
                                            }
                                        ?>
                                      ...
                                      <button style="color:#FFF;" type="submit" name = "delsubmt" class="btn btn-info btn-icon-text mt-3"><i class="ti-trash btn-icon-prepend"></i>Delete</button>
                                      <?php
                                        if(isset($_POST["delsubmt"])) {
                                          $res = $cat->del_subcat($_POST["t2"]);
                                          if($res) {
