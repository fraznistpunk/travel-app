...
<?php } ?>
	<div class="col-md-3 image-grid">
		...
		<small><a href="#"><?php echo $data[2]; ?></a></small>
	</div>
<?php if($n%4==3) {
?>
</div>
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#70B8E8">MyTour Tourism</h4>
						...
						<h5 style="color:#000"><span class="img3"></span>1100 High Street, Model Town Delhi.</h5>
                        <br/>
